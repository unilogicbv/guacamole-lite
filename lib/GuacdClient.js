...
class GuacdClient {
    ...
    sendHandshakeReply() {
        ...
        this.sendOpCode(['audio', 'audio/L16', 'audio/L8']);
    ...
    sendOpCode(opCode) {
        ...
        this.log(this.server.LOGLEVEL.DEBUG, 'Sending opCode: ' + opCode);
        this.send(opCode);
    }
    ...
    static parseOpCodePartStr(opCodePartStr) {
        // TODO: need to process string to revert "," and "."'s which are part of the protocol
